...
import (
	...
	"github.com/taubyte/vm-wasm-utils/leb128"
)
...
func (m *Module) validateTable(enabledFeatures Features, tables []*Table, maximumTableIndex uint32) ([]*validatedActiveElementSegment, error) {
